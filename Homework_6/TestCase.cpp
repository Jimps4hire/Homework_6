...
void TestCase::CreateParts(RobotShop* shop)
{
	...
	// arm
	list<RobotPart*> armlist = inv->getArmList();
	...
	// head
	list<RobotPart*> headlist = inv->getHeadList();
	...
	// locomotor
	list<RobotPart*> locomotorlist = inv->getLocomotorList();
	...
	// torso
	list<RobotPart*> torsolist = inv->getTorsoList();
	...
	// battery
	list<RobotPart*> batterylist = inv->getBatteryList();
